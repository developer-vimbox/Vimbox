...
('ChangePassword.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
...
('EditTicket.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
('FullTimeEmployees.jsp', 'Admin|HR'),
('header.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
...
('RetrieveTicketComment.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
('SalesOperations.jsp', 'Admin|Sales'),
('SalesSites.jsp', 'Admin|Sales'),
('SearchCustomers.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
('SearchCustomersByName.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
('SearchSecondaryServices.jsp', 'Admin|Sales'),
('SearchTickets.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
...
('SupervisorDailyJobs.jsp', 'Admin|Operation'),
('SupervisorEditAttendance.jsp', 'Admin|Operation'),
('SupervisorJobs.jsp', 'Admin|Operation'),
('SupervisorJobsCalendar.jsp', 'Admin|Operation'),
...
('TicketsHistory.jsp', 'Admin|Operation|SiteSurvey|HR|Sales'),
