...
<%
    ...
    ArrayList<User> siteSurveyors = UserDAO.getSiteSurveyorsByName(request.getParameter("siteSurveyor"));
...
<table border="1" width="100%">
    ...
    <tr>
            ...
            <table width="100%">
                <tr>
                    <td>
                        ...
                        <div id="tableForm">
                            <table width="100%" border="1" id="sitesurveyor_table">
                                <tr>
                                    <th></th>
                                        <%
        ...
        <td>
            <table width="100%">
                <tr>
                    <td align="center" colspan="2"><button style="width:100%" onclick="toggleView();
                            return false;">Toggle</button></td>
                </tr>
                <tr>
                    <td colspan="2">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button onclick="selectSurveyor(); return false;">Select</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button onclick="selectTimeSlot(); return false;">+</button>
                                    </td> 
                                </tr>
                            </table>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="site_remarks"><%if(remarks != null)out.println(remarks);%></textarea>
                    </td>
                </tr>
                <tr>
