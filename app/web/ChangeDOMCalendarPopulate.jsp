                ...
                <td class="fc-day fc-mon fc-widget-content fc-future fc-last" id="day_<%=curDate%>" style="vertical-align: top;">
                    ...
                    <div style="min-height: 120px;">
                        <div class="fc-day-number" style="font-size: 16px; padding-top: 2px;">
                            ...
                            %>
                            <button class="btn btn-round btn-primary" onclick="viewChangeDOMDaySchedule('<%=strDate%>','<%=details%>');">
                                <%=curDate%>
                            </button>
                            <%
                            } else { // past dates
                            ...
                            %>
                            <button class="btn btn-round btn-default" onclick="viewChangeDOMDaySchedule('<%=strDate%>','<%=details%>');">
                                <%=curDate%>
                            </button>
                            <%
                                }
