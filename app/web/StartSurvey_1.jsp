                                                    ...
                                                    <table width="100%" border="1" height="100%">
                                                        <tr height="10%">
                                                            <td>
                                                                ...
                                                                <button style="width:100%;height:100%;" onclick="confirmComplete();
                                                            ...
                                                            <td colspan="2">
                                                                <table class='table table-bordered' width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button style="width:100%" onclick="loadSurveyItemsTable($('#<%=aT%>_<%=areaCounter%>_search').val(), '<%=aT%>', '<%=areaCounter%>', '<%=salesDiv%>');
                                                                                    return false;">Search</button>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2" width="50%" align="center" class="selected" onclick="showTableDiv(this, '<%=aT%>', '<%=areaCounter%>', 'ItemsDiv');
                                                                                return false;"><b>CUSTOMER</b></td>
                                                                        <td align="center" onclick="showTableDiv(this, '<%=aT%>', '<%=areaCounter%>', 'VimboxDiv');
                                                                    ...
                                                                    <table class='table table-bordered' width="100%">
                                                                        ...
                                                                        <tr height="300">
                                                                            <td colspan="6" valign="top">
                                                                                <table class='table table-bordered' width="100%" id="<%=aT%>_<%=areaCounter%>_SelectedItemsTable">
                                                                                    <col width="20%">
                                                                                    <col width="45%">
                                                                                    <col width="10%">
                                                                                    <col width="10%">
                                                                        ...
                                                                        <tr height="300">
                                                                            <td colspan="6" valign="top">
                                                                                <table class='table table-bordered' width="100%" id="<%=aT%>_<%=areaCounter%>_SelectedVimboxTable">
                                                                                    <col width="20%">
                                                                                    <col width="45%">
                                                                                    <col width="10%">
                                                                                    <col width="10%">
