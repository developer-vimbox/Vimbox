                                        ...
                                        <td>
                                            <div id='content'>
                                                <div id='siteInfo' style='display:block;height:790px;'>
                                                    ...
                                                    <br><br>
                                                    <ul class="nav-responsive nav nav-tabs" id='from-to'>
                                                            ...
                                                            <ul class="nav-responsive nav nav-tabs">
                                                                <%
                                                                    ...
                                                                    for (String address : addressesFrom) {
                                                                        ...
                                                                        if (tcount == 0) {
                                                                            out.println("<li class='active' onclick='showSiteInfoTables(" + divId + "," +"from_" + tcount +"," + address +"," + leadId +")'><a href='#from_" + tcount + "' data-toggle='tab'>" + address + "</a></li>");
                                                                        } else {
                                                                             out.println("<li onclick='showSiteInfoTables(" + divId + "," +"from_" + tcount +"," + leadId +")'><a href='#from_" + address + "' data-toggle='tab'>" + address + "</a></li>");
                                                                        }
                                                                        tcount++;
                                                                    }%>
                                                            </ul>
                                                            <div class="tab-content">
                                                                <div id='fromContent'></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id='to' class="tab-pane">
                                                            <%
                                                                for (String address : addressesTo) {
                                                                    ...
                                                                    out.println("<table style='width:100%;border-color: #dfe8f1;' border='1'>");
                                                                            ...
                                                                            for (LeadArea leadArea : areas) {
                                                                                ...
                                                                                if (!leadAreaString.isEmpty()) {
                                                                                    ...
                                                                                    for (Item item : vimboxItems) {
                                                                                        ...
                                                                                        out.println("<td align='center'><input class='btn btn-default' type='button' value='x' onclick=\"deleteSiteItem(this, '" + aT + "_" + areaCounter + "_SelectedVimboxTable" + "', '" + divId + "')\"/></td>");
                                                                                        out.println("</tr>");
                                                                                        trCounter++;
                                                                                    }
                                                                                    out.println("</table></td></tr>");
                                                            ...
                                                            <div id="<%=divId%>_serviceModal" class="service">
                                                                ...
                                                                <div class="service-content">
                                                                    <div class="service-body">
                                                                        ...
                                                                        <table style='width:100%;table-layout:fixed;border-color: #dfe8f1;' border="1"  id="<%=divId%>_serviceTable">
                                                                            <%
                                                ...
                                                <table class='table table-bordered' style='width:100%;height:100%;border-color: #dfe8f1;' border="1">
                                                                        ...
                                                                        <div class="form-group" style='margin-left:10%!important'>
                                                                            <div class="col-sm-3">
                                                                                <div style="width: 300%;" class="input-group bootstrap-touchspin"><span class="input-group-addon bootstrap-touchspin-prefix" style="display: none;"></span>
                                                                                    <input type="text" id="<%=aT%>_<%=areaCounter%>_search"  placeholder="Search Item Name" class="form-control" style="color:black;">
                                                                                ...
                                                                                <tbody>
                                                                                    <%
                                                                                        ...
                                                                                        for (Item item : customerItems) {
                                                                                            ...
                                                                                            out.println("<td align='center'><input class='btn btn-default' type='button' value='x' onclick=\"deleteSiteItem(this, '" + aT + "_" + areaCounter + "_SelectedItemsTable" + "', '" + salesDiv + "')\"/></td>");
                                                                                            out.println("</tr>");
                                                                                            trCounter++;
                                                                                        }
                                                                                    %>
                                                                                ...
                                                                                <tbody>
                                                                                    <%
                                                                                        ...
                                                                                        for (Item item : vimboxItems) {
                                                                                            ...
                                                                                            out.println("<td align='center'><input type='hidden' value='" + item.getQty() + "'>" + item.getQty() + "</td>");
                                                                                            out.println("<td align='center'><input type='hidden' value='" + item.getUnits() + "'>" + item.getUnits() + "</td>");
                                                                                            out.println("<td align='center'><input class='btn btn-default' type='button' value='x' onclick=\"deleteSiteItem(this, '" + aT + "_" + areaCounter + "_SelectedVimboxTable" + "', '" + salesDiv + "')\"/></td>");
                                                                                            out.println("</tr>");
                                                                                            trCounter++;
                                                                                        }
                                                                                    %>                                      
                                                    ...
                                                    <tr height="20">
                                                        <td align="center" onclick="addNew('<%=aT%>', '<%=areaCounter%>', '', this);
                                                                return false;">New</td>
