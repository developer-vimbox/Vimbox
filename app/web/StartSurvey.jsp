                                            ...
                                            <div id='content'>
                                                <div id='siteInfo' style='display:block;height:790px;'>
                                                    ...
                                                    <ul class="nav-responsive nav nav-tabs" id='from-to'>
                                                        <li class="active"><a href="#from" data-toggle="tab" onclick='displayfromdefault()'>FROM</a></li>
                                                        <li ><a href="#to" data-toggle="tab" onclick='displaytodefault()'>TO</a></li>
                                                    </ul>
                                                            ...
                                                            <ul class="nav-responsive nav nav-tabs">
                                                                <%
                                                                    ...
                                                                    for (String address : addressesFrom) {
                                                                        ...
                                                                        String ahref = "from_" + tcount;
                                                                        if (tcount == 0) {%>
                                                                <li id='fromonload' class='active' onclick="showSiteInfoTables('<%=divId%>', '<%=ahref%>', '<%=address%>', '<%=leadId%>', 'from')">
                                                                    <a href="#<%=ahref%>" data-toggle='tab'><%=address%></a>
                                                                </li>
                                                                <% } else {%>
                                                                <li  onclick="showSiteInfoTables('<%=divId%>', '<%=ahref%>', '<%=address%>', '<%=leadId%>', 'from')">
                                                                    <a href="#<%=ahref%>" data-toggle='tab'><%=address%></a>
                                                                </li>   
                                                                <%}
                                                                        tcount++;
                                                            ...
                                                            <ul class="nav-responsive nav nav-tabs">
                                                                <%
                                                                    ...
                                                                    for (String address : addressesTo) {
                                                                        LeadDiv leadDiv = lead.getSalesDivByAddress(address);
                                                                        String divId = (leadDiv.getSalesDiv().split("\\|"))[0];
                                                                        String ahref = "to_" + tcount;
                                                                        if (tcount == 0) {%>
                                                                <li class='active' id='toonload' onclick="showSiteInfoTables('<%=divId%>', '<%=ahref%>', '<%=address%>', '<%=leadId%>', 'to')">
                                                                    <a href="#<%=ahref%>" data-toggle='tab'><%=address%></a>
                                                                </li>
                                                                <% } else {%>
                                                                <li  onclick="showSiteInfoTables('<%=divId%>', '<%=ahref%>', '<%=address%>', '<%=leadId%>', 'to')">
                                                                    <a href="#<%=ahref%>" data-toggle='tab'><%=address%></a>
                                                                </li>   
                                                                <%}
                                                                        tcount++;
