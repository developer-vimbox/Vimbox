                                                    ...
                                                    <div id='content'>
                                                        <div id='siteInfo' style='display:block;height:790px;'>
                                                            ...
                                                            <%
                                                                ...
                                                                out.println("<td valign='top'>");
                                                                out.println("<table border='1' style='border-color: #dfe8f1;width:100%'>");
                                                                out.println("<col width='50%'");
                                                                out.println("<tr>");
                                                            ...
                                                            <div id="<%=divId%>_serviceModal" class="service">
                                                                ...
                                                                <div class="service-content">
                                                                    <div class="service-body">
                                                                        ...
                                                                        <table style='width:100%;border-color: #dfe8f1;table-layout: fixed;' border="1" id="<%=divId%>_serviceTable">
                                                                            <%
