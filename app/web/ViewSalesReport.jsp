                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <select name="assigned" class="form-control" onchange="showSalesReport(this)">
                                 ...
                                 <div class='form-group'>
                                    ...
                                    <div class="col-sm-5">
                                        <input  class="form-control" id="seldate" type="date" name="seldate" value='<%=date%>' onchange='showWeekReport()'>
