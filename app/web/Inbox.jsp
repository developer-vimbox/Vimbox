...
<html>
    ...
    <body onload="loadMessages('Inbox')">
                            ...
                            <div class="content-box">
                                ...
                                <div class="mail-toolbar clearfix">
                                    <div class="float-left">
                                        <a class="btn btn-default mrg5R" onclick="refresh('Inbox')">
                                            <i class="glyph-icon font-size-11 icon-refresh"></i>
                                        </a>
                                        <a class="btn btn-default mrg5R" onclick="deleteMail('Inbox')">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu float-right">
                                                <%
                                                    String[] folders = new String[]{"[Gmail]/Sent Mail", "[Gmail]/Drafts", "[Gmail]/Spam"};
                                                    for(String folder : folders){
                                                %>
                                                    <li>
                                                        <a onclick="moveTo('<%=folder%>', 'Inbox')">
