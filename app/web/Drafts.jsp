                            ...
                            <div class="content-box">
                                ...
                                <div class="mail-toolbar clearfix">
                                    <div class="float-left">
                                        <a class="btn btn-default mrg5R" onclick="refresh('[Gmail]/Drafts')">
                                            <i class="glyph-icon font-size-11 icon-refresh"></i>
                                        </a>
                                        <a class="btn btn-default mrg5R" onclick="deleteMail('[Gmail]/Drafts')">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu float-right">
                                                <%
                                                    String[] folders = new String[]{"Inbox", "[Gmail]/Sent Mail", "[Gmail]/Spam"};
