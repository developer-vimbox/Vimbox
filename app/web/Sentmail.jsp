...
<html>
    ...
    <body onload="loadMessages('[Gmail]/Sent Mail')">
                        ...
                        <div class="panel-body">
                            <div class="content-box">
                                <div class="mail-header clearfix row">
                                    <div class="col-md-8">
                                        <span class="mail-title">Sent Mail</span>
                                    </div>
                                ...
                                <div class="mail-toolbar clearfix">
                                    <div class="float-left">
                                        <a class="btn btn-default mrg5R" onclick="refresh('[Gmail]/Sent Mail')">
                                            <i class="glyph-icon font-size-11 icon-refresh"></i>
                                        </a>
                                        <a class="btn btn-default mrg5R" onclick="deleteMail('[Gmail]/Sent Mail')">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu float-right">
                                                <%
                                                    String[] folders = new String[]{"Inbox", "[Gmail]/Drafts", "[Gmail]/Spam"};
                                                    for(String folder : folders){
                                                %>
                                                    <li>
                                                        <a onclick="moveTo('<%=folder%>', '[Gmail]/Drafts')">
