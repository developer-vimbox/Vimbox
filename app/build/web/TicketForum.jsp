    ...
    <body>
        ...
        <div class="modal" id="viewTicketModal">
            <div class="modal-content">
                <div class="modal-body" id="viewTicketModalContent">
                                        ...
                                        <div class="panel-body">
                                            <div class="example-box-wrapper">
                                                <ul class="nav-responsive nav nav-tabs">
                                                    <li><a href="#pendingTicks" data-toggle="tab"><h3>Pending Tickets</h3></a></li>
                                                    <li><a href="#resolvedTicks" data-toggle="tab"><h3>Resolved Tickets</h3></a></li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane" id="pendingTicks">
                                                    ...
                                                    <div id="resolvedTicks" class="tab-pane">
                                                        <div class="form-group">
                                                            <div class="col-sm-4">
                                                                <div class="input-group bootstrap-touchspin"><span class="input-group-addon bootstrap-touchspin-prefix" style="display: none;"></span>
                                                        ...
                                                        <table class="table table-hover">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><%=status%></td>
                                                                <td>
                                                                    <button class="btn btn-default " value="<%=ticketId%>" onclick="viewTicket('<%=ticketId%>')" style="margin-bottom: 20px;">View Ticket</button>
                                                                    <button class="btn btn-default " value="<%=ticketId%>" onclick="viewComments('<%=ticketId%>')">View Comments</button>
