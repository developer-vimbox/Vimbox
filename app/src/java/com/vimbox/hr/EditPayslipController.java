...
@WebServlet(name = "EditPayslipController", urlPatterns = {"/EditPayslipController"})
public class EditPayslipController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int payslip_id = Integer.parseInt(request.getParameter("payslip_id"));
        ...
        if(nric.isEmpty()){                         
            ...
            String od = request.getParameter("original_startDate");
            String originalMonth = od.substring(od.indexOf("-") + 1, od.lastIndexOf("-"));
            String newMonth = sd.substring(sd.indexOf("-") + 1, sd.lastIndexOf("-"));
        ...
        if(errorMsg.isEmpty()){
            PayslipDAO.deletePayslip(payslip_id);
            ...
            jsonOutput.addProperty("message", "Payslip edited!");
        }else{
