...
@WebServlet(name = "MCPDFGenerator", urlPatterns = {"/mcs/*"})
public class MCPDFGenerator extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fileName = request.getParameter("mc_name");
        String ext = fileName.substring(fileName.lastIndexOf(".") + 1);
        String path = System.getProperty("user.dir") + "/documents/mc/" + fileName;
