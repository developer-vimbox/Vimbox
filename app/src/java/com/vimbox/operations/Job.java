...
public class Job {
    ...
    public Job(int leadId, User owner, User supervisor, Truck assignedTruck, Date dom, HashMap<String, String> addresses, DateTime start, DateTime end, String remarks, String timeslot, String status) {
        this.leadId = leadId;
