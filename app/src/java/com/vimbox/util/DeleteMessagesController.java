...
@WebServlet(name = "DeleteMessagesController", urlPatterns = {"/DeleteMessagesController"})
public class DeleteMessagesController extends HttpServlet {
...
//                    System.out.println(">> "+fd.getName());
            ...
            if (!type.contains("Trash") && !type.contains("Spam")) {
                Folder destFolder = (Folder) session.getAttribute("[Gmail]/Trash");
                if (destFolder == null) {
                    //create properties field
                    Properties properties = new Properties();
                    ...
                    //create the folder object and open it
                    destFolder = store.getFolder("[Gmail]/Trash");
                    destFolder.open(Folder.READ_WRITE);
//                Folder[] f = store.getDefaultFolder().list("*");
//                for(Folder fd:f)
//                    System.out.println(">> "+fd.getName());
                    session.setAttribute("[Gmail]/Trash", destFolder);
                }
