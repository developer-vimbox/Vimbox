...
public class JobDAO {
    ...
    public static ArrayList<Job> getJobsBySupervisor(String nric){
        DateTimeFormatter dtf = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss");
        ArrayList<Job> results = new ArrayList<Job>();
        Connection con = null;
        PreparedStatement ps = null;
        ...
        try {
            con = ConnectionManager.getConnection();
            ps = con.prepareStatement(GET_JOBS_BY_SUPERVISOR);
            ps.setString(1, nric);
            rs = ps.executeQuery();
    ...
    public static ArrayList<Job> getJobsBySupervisorAndDate(String nric, String date){
        DateTimeFormatter dtf = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss");
        ArrayList<Job> results = new ArrayList<Job>();
        Connection con = null;
        PreparedStatement ps = null;
        ...
        try {
            con = ConnectionManager.getConnection();
            ps = con.prepareStatement(GET_JOBS_BY_SUPERVISOR_AND_DATE);
            ps.setString(1, nric);
            ps.setString(2, date);
            rs = ps.executeQuery();
    ...
    public static ArrayList<Job> getJobsForSupervisors(){
        DateTimeFormatter dtf = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss");
        ArrayList<Job> results = new ArrayList<Job>();
        Connection con = null;
        PreparedStatement ps = null;
        ...
        try {
            con = ConnectionManager.getConnection();
            ps = con.prepareStatement(GET_JOBS_FOR_SUPERVISORS);
            rs = ps.executeQuery();
            ...
            while (rs.next()) {
                ...
                //User supervisor = supervisor = UserDAO.getUserByNRIC(rs.getString("supervisor"));
    ...
    public static ArrayList<Job> getJobsByDom(String date){
        DateTimeFormatter dtf = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss");
        ArrayList<Job> results = new ArrayList<Job>();
        Connection con = null;
        PreparedStatement ps = null;
        ...
        try {
            con = ConnectionManager.getConnection();
            ps = con.prepareStatement(GET_JOBS_BY_DOM);
            ps.setString(1, date);
            rs = ps.executeQuery();
