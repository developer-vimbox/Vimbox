...
@WebServlet(name = "EmailQuotationController", urlPatterns = {"/EmailQuotationController"})
public class EmailQuotationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pdfPath = System.getProperty("user.dir") + "/documents/quotations/" + refNum + ".pdf";
        ...
        try {
            ...
            message.setSubject("Move Quotation - " + refNum + " (Reference no.)");

            // Create the message part
            BodyPart messageBodyPart = new MimeBodyPart();
            String content = "Dear customer,<br><br>The attached file is your quotation that you have requested.";
            ...
            messageBodyPart.setFileName(pdfPath.substring(pdfPath.lastIndexOf("/")));
            multipart.addBodyPart(messageBodyPart);
            ...
            jsonOutput.addProperty("message", "Quotation sent!");
        } catch (Exception e) {
            e.printStackTrace();
